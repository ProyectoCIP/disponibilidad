    ...
    protected Module newIsisWicketModule() {
        ...
        final Module quickstartOverrides = new AbstractModule() {
            ...
            protected void configure() {
                ...
                bind(String.class).annotatedWith(Names.named("applicationName")).toInstance("Hostería La Morada Petit Hotel");
                ...
                bind(String.class).annotatedWith(Names.named("aboutMessage")).toInstance("Gestión Hotelera");
